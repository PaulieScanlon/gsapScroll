      ...
      <div className="grid grid-cols-1 gap-y-6 gap-x-6 px-12 lg:grid-cols-2 lg:gap-x-8 lg:gap-y-8 lg:px-8">
        <div className=" justify-around pb-0 pt-6 sm:flex lg:py-6">
          <div className="sm:flex-shrink">
            <div className="block rounded-2xl rounded-tl-none border border-slate-400 bg-gradient-to-r from-purple-900 to-purple-600 text-center">
        ...
        <div className="justify-around pt-0 pb-6 sm:flex lg:py-6">
          <div className="sm:flex-shrink">
            <div className="flow-root">
              <div className="block rounded-2xl rounded-tl-none border border-gray-400 bg-gradient-to-r from-purple-600 to-sky-600 text-center">
