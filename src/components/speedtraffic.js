...
export default function Conversions() {
  return (
    <div
      id="speed"
      className="max-w-xl container mx-auto my-6 rounded-3xl bg-gradient-to-r bg-[url('https://res.cloudinary.com/gravital-digital/image/upload/v1657331225/speed-bg-traffic_pyz6w4.jpg')] from-slate-900 to-red-900 bg-cover bg-right"
    >
