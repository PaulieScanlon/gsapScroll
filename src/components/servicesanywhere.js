...
export default function Example() {
  return (
    <div className="max-w-xl container mx-auto my-24 rounded-3xl bg-[url('https://res.cloudinary.com/gravital-digital/image/upload/v1655819450/faded-sun_1500x750px_f95cpq.jpg')]">
