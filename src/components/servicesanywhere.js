...
export default function Example() {
  return (
    <div className="max-w-xl container mx-auto mb-6 rounded-3xl bg-gradient-to-r bg-[url('https://res.cloudinary.com/gravital-digital/image/upload/v1656977286/blue-background-lt-left_vzcl5v.jpg')] from-sky-900 to-blue-900 bg-cover">
