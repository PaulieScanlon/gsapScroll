          ...
          <div className="justify-around pb-0 pt-6 sm:px-6 md:flex md:flex-row md:py-12">
            <div className="sm:flex-shrink">
              <div className="flow-root">
                <h1 className="mt-2 text-4xl font-black text-sky-50 sm:mt-12 sm:text-6xl md:mt-0 lg:mt-2 lg:text-7xl">
                  Speed.
                </h1>
                <h1 className="mt-5 text-4xl font-black text-amber-500 sm:mt-10 sm:text-5xl lg:mt-20 lg:text-6xl">
                  8%
                </h1>
                <h2 className="font-regular mt-2 text-3xl text-slate-50 sm:text-4xl lg:text-5xl">
