          ...
          <div className="justify-around pb-0 pt-6 sm:py-0 md:flex md:flex-row md:py-12">
            <div className="sm:flex-shrink">
              <div className="flow-root">
                ...
                <h1 className="lg:mt-15 ml-6 mt-3 text-3xl font-black text-amber-700 sm:mt-7 sm:text-4xl lg:text-5xl">
                  8.4%
                </h1>
                <h2 className="ml-6 mt-2 text-2xl font-bold text-slate-50 sm:text-3xl lg:text-4xl">
                  conversions per 100ms for retail sites
                </h2>
                <h1 className="lg:mt-15 ml-6 mt-3 text-3xl font-black text-red-500 sm:mt-7 sm:text-4xl lg:text-5xl">
                  10.1%
                </h1>
                <h2 className="ml-6 mt-2 text-2xl font-bold text-slate-50 sm:text-3xl lg:text-4xl">
