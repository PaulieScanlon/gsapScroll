...
export default function Zerocosts() {
  return (
    <div className="max-w-xl container mx-auto my-6 rounded-3xl bg-slate-900 bg-[url('https://res.cloudinary.com/gravital-digital/image/upload/v1656980624/background-light-right_xfsxax.jpg')] bg-cover">
